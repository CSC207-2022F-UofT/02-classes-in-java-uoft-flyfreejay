...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param first first half of this Silly instance's name
     * @param second second half of this Silly instance's name
     */
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        if (this.name.length() > other.toString().length()){
            return 1;
        } else if (this.name.length() < other.toString().length()){
            return -1;
        } else {
            return 0;
        }
